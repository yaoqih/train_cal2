...
hidden_imports = [
    ...
    "stage1_simple.solve",
    "stage2_simple.solve",
    "stage2_simple.episodes",
    "stage2_simple.model",
    "stage2_simple.optimizer",
    "stage2_simple.yard",
    "stage3_simple.solve",
    "stage4_simple.solve",
    "stage4_simple.construct",
    "stage4_simple.contracts",
    "stage4_simple.domain",
    "stage4_simple.model",
    "stage4_simple.optimizer",
    "stage4_simple.planner",
    "stage4_simple.scope",
    "stage4_simple.search",
    "stage4_simple.topology",
